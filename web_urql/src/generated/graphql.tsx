...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'title' | 'description' | 'descriptionSnippet' | 'points' | 'voteStatus' | 'createdAt' | 'updatedAt'>
  & { creator: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'email' | 'firstname' | 'lastname' | 'username' | 'createdAt' | 'updatedAt'>
  ) }
);
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'description' | 'points' | 'createdAt' | 'updatedAt'>
  ) }
);
...
export type UpdatePostMutation = (
  ...
  & { updatePost?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'descriptionSnippet' | 'description'>
  )> }
);
...
export const RegisterDocument = gql`
    mutation Register($username: String!, $email: String!, $firstname: String!, $lastname: String!, $password: String!) {
  register(
    options: {username: $username, email: $email, lastname: $lastname, firstname: $firstname, password: $password}
  ) {
    ...RegularUserResponse
  }
}
