...
let PostResolver = class PostResolver {
    ...
    voteStatus(post, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updoot = yield ctx.updootLoader.load({ userId: ctx.req.session.userId, postId: post.id });
    ...
    posts(limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const posts = yield typeorm_1.getConnection().query(`select p.* from post p ${cursor > 0 ? `where p.id <= ${cursor}` : ''} order by p.createdAt DESC limit ${realLimitPlusOne}`);
            return {
    ...
    updatePost(id, title, description, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (post.raw.changedRows === 1) {
                return Post_1.Post.findOne({ id, creatorId: ctx.req.session.userId });
            }
