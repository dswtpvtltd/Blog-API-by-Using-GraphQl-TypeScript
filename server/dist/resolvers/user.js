...
let UserResolver = class UserResolver {
    ...
    changePassword(token, newPassword, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const key = contants_1.FORGET_PASSWORD_PREFIX + token;
            ...
            User_1.User.update({ id: userId }, { password: yield argon2_1.default.hash(newPassword) });
    ...
    forgotPassword({ redis }, email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(contants_1.FORGET_PASSWORD_PREFIX + token, user.id, 'ex', 5000);
            yield sendEmail_1.sendEmail('Forget password', 'dev@gmail.com', `<a href="http://localhost:3000/change-password/${token}">reset password</a>`);
            return true;
        });
    }
    me(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.User.findOne({ id: ctx.req.session.userId });
            return user;
        });
    }
    ...
    logout({ req, res }) {
        return new Promise((resolve) => req.session.destroy((err) => {
            ...
            res.clearCookie(contants_1.COOKIE_NAME);
            resolve(true);
        }));
    }
};
